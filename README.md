...
cp -r hermes-themes ~/.hermes/skills/hermes-themes/

# Option B: Install directly from this repository's raw SKILL.md URL
<agent-cli> skills install https://raw.githubusercontent.com/iizcm/hermes-themes-skill/main/SKILL.md

# Option C: Clone this entire repo into your skills directory
git clone https://github.com/iizcm/hermes-themes-skill.git ~/.hermes/skills/hermes-themes/
```
...
```text
Use the hermes themes skill to <describe your specific task here>
```
...
```text
Gunakan skill hermes themes untuk <deskripsikan tugas spesifik Anda di sini>
```
